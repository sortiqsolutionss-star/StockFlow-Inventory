 ...
 * Description: Core initialization entrypoint for mounting the React Single Page
 * Application onto the index.html target node within strict execution wrappers.
 */
